...
const buyerMenu = [
  { name: 'Dashboard Overview', id: 'buyer-overview', href: '/dashboard/buyer', icon: BarChart3 },
  { name: 'Product Browsing', id: 'buyer-products', href: '/dashboard/buyer/products', icon: Search },
  { name: 'Advanced Filters', id: 'buyer-filters', href: '/dashboard/buyer/filters', icon: Filter },
  { name: 'Bulk Orders (Cart)', id: 'buyer-bulk', href: '/dashboard/buyer/cart', icon: Package },
  { name: 'RFQ Creation', id: 'buyer-rfqs', href: '/dashboard/buyer/rfqs', icon: FileText },
  { name: 'Real-time Chat', id: 'buyer-chat', href: '/dashboard/buyer/chat', icon: Mail },
  { name: 'Proposal Management', id: 'buyer-proposals', href: '/dashboard/buyer/proposals', icon: FileText },
  { name: 'Order Tracking', id: 'buyer-orders', href: '/dashboard/buyer/orders', icon: Truck },
  { name: 'Contract Viewing', id: 'buyer-contracts', href: '/dashboard/buyer/contracts', icon: FileText },
  { name: 'Blockchain Trust', id: 'buyer-blockchain', href: '/dashboard/buyer/blockchain', icon: ShieldCheck },
  { name: 'Supplier Ratings', id: 'buyer-ratings', href: '/dashboard/buyer/ratings', icon: CheckCircle },
  { name: 'Profile & History', id: 'buyer-profile', href: '/dashboard/buyer/profile', icon: UserIcon },
  { name: 'Forecast Dashboard', id: 'buyer-forecast', href: '/dashboard/buyer/forecast', icon: BarChart3 },
  { name: 'Logistics Tracking', id: 'buyer-logistics', href: '/dashboard/buyer/logistics', icon: Truck },
  { name: 'Inventory Planning', id: 'buyer-inventory', href: '/dashboard/buyer/inventory-planning', icon: Boxes },
  { name: 'Auto Reorder Logic', id: 'buyer-auto-reorder', href: '/dashboard/buyer/auto-reorder', icon: Target },
  { name: 'Supplier Comparison', id: 'buyer-compare', href: '/dashboard/buyer/comparison', icon: Map },
  { name: 'Payment Tracking', id: 'buyer-payments', href: '/dashboard/buyer/payments', icon: FileText },
  { name: 'Analytics Dashboard', id: 'buyer-analytics', href: '/dashboard/buyer/analytics', icon: BarChart3 },
  { name: 'User Roles (RBAC)', id: 'buyer-rbac', href: '/dashboard/buyer/rbac', icon: Shield },
  { name: 'Data Export', id: 'buyer-export', href: '/dashboard/buyer/export', icon: Globe },
];
